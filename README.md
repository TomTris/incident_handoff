...
- [ ] Phase 6.0 — Frontend Basic
- [ ] Phase 6 — TypeScript + Vue.js
- [ ] Phase 7 — Full Handoff Frontend
- [ ] Phase 8 — Testing
- [ ] Phase 9 — Ship It

## Learning
If you want to learn about Fullstack-engineering and want to have a curriculum to build an Incident Handoff step by step, chek out [`learning/README.md`](learning/README.md)
